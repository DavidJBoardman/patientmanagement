...
urlpatterns = [
    ...
    path('patient/<int:id>/add_diagnosis', views.edit_diagnosis_view, name='add-diag'),
    ...
    path('patient/<int:id>/edit_diagnosis/<int:diagnosis>', views.edit_diagnosis_view, name='add-diag'),
